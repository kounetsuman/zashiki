 ...
 * Three states: normal `↻`, a spinner while fetching, and `⚠` on error with the
 * error content shown as a tooltip on hover.
  ...
  return (
    ...
    >
      {state === "loading" ? (
        ...
        <span className="panel-refresh-alert" aria-hidden="true">
          ⚠
        </span>
      ) : (
        "↻"
